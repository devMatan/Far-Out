...
public class GameEngine {
    ...
    public void changeLevel(){
        ...
        switch (currentLevel){
            case 0:
                scene = new FirstStage(pWidth, pHeight, numOfPlayers, this, "-= STAGE 1.0 =-", new int[]{5, 5, 5});
                break;
            case 1:
                scene = new SecondStage(pWidth, pHeight, numOfPlayers, this, "-= STAGE 2.0 =-", new int[]{5, 5, 5, 5});
                break;
            case 2:
                scene = new ThirdStage(pWidth, pHeight, numOfPlayers, this, "-= STAGE 3.0 =-", new int[]{5, 5, 5, 8});
                break;
            case 3:
                scene = new FourthStage(pWidth, pHeight, numOfPlayers, this, "-= STAGE 4.0 =-", new int[]{5, 5, 10, 10});
                break;
            case 4:
                scene = new FifthStage(pWidth, pHeight, numOfPlayers, this, "-= STAGE 5.0 =-", new int[]{5, 5, 5, 15, 20});//, 8});
                break;
            case 5:
                scene = new BlitzStage(pWidth, pHeight, numOfPlayers, this, "-= BLITZ STAGE =-", new int[]{5, 0, 15, 25});//, 0, 0, 0, 0});
                break;
